...
def main():
    ...
    cd_maturity = int(input('What is the length of months you want to calculate the interest gained on the account? '))
    ...
    print('The future CD balance after',cd_maturity,'months is: $', format(updated_cd_balance, ',.2f'))
